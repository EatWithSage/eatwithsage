...
export default function FoodBrandsPage() {
  return (
    <>
      ...
      <meta name="description" content="Transform your food brand's customer engagement with Sage's AI-powered meal planning platform. Drive brand loyalty and product discovery." />
