            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Integrate Sage's comprehensive meal planning capabilities into your tech platform through our API-first architecture. White-label our AI-powered nutrition engine to enhance your app with personalized meal recommendations, smart grocery lists, and seamless user experiences.
                </p>
              </div>
            </div>
          </section>
